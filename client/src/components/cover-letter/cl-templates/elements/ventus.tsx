...
import VentusCss from "@/styles/cover-letter/templates/elements/ventus.css?inline";
import { formatText } from "@/utils/helper";

const Ventus: React.FC<CLTemplateProps> = ({ data }) => {
  return (
    <>
      <style>
        {VentusCss}
      ...
      <div className="cover-letter-template">
        ...
        <div className="letter-main">
          <aside className="recipient-column">
